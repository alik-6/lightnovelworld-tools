...
var useStorage = (key, initialValue) => {
...
// src/popup/component/TTSAutoNext.tsx
var jsx_dev_runtime = __toESM(require_jsx_dev_runtime(), 1);
function TTSAutoNext() {
  const [isAutoNext, setAutoNext] = useStorage_default("AutoNext", false);
...
// src/popup/component/TTSAutoPlay.tsx
var jsx_dev_runtime2 = __toESM(require_jsx_dev_runtime(), 1);
function TTSAutoPlay() {
  const [isAutoPlaying, setAutoPlaying] = useStorage_default("AutoPlaying", false);
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
        children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(TTSAutoPlay, {}, undefined, false, undefined, this)
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
        children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(TTSAutoNext, {}, undefined, false, undefined, this)
      }, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this);
}
...
function renderPopup() {
  const T_POP = document.getElementById("T_POP");
  if (T_POP && !T_POP._root) {
    T_POP._root = import_client.default.createRoot(T_POP);
    T_POP._root.render(/* @__PURE__ */ jsx_dev_runtime4.jsxDEV(import_react2.default.StrictMode, {
...
// src/observers/CCO.ts
function CCOCallback(mutations, observer) {
  mutations.forEach((mutation) => {
    if (mutation.type === "attributes") {
      const cle = getCLE();
      if (cle && !cle.classList.contains("tts-highlight")) {
        const nextPageElement = document.querySelector("#chapter-article > section > div.chapternav.skiptranslate > a.button.nextchap");
...
var CCO_default = new MutationObserver(CCOCallback);

// src/observers/TTSDO.ts
function TTSDCallback(mutations, observer) {
  mutations.forEach((mutation) => {
...
var TTSDO_default = new MutationObserver(TTSDCallback);

// src/content-script.ts
var CCLCInterval = setInterval(() => {
  ...
  if (chapterLastElement) {
    ...
    CCO_default.observe(chapterLastElement, {
      attributes: true,
      attributeFilter: ["class"]
    });
  }
}, 100);
var TTSDInterval = setInterval(() => {
  const textToSpeechDialogElement = getTTSD();
  if (textToSpeechDialogElement) {
    clearInterval(TTSDInterval);
    TTSDO_default.observe(textToSpeechDialogElement, {
      attributes: true,
      attributeFilter: ["class"]
    });
  }
